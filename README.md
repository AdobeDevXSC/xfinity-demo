...
## Environments
- Preview: https://main--xfinity-demo--adobedevxsc.aem.page/
- Live: https://main--xfinity-demo--adobedevxsc.aem.live/
...
1. Open the `xfinity-demo` directory in your favorite IDE and start coding :)
