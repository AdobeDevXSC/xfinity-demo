# Xfinity - Universal Editor (XWalk)


## Environments
- Preview: https://main--xfinity-xwalk--adobedevxsc.aem.page/
- Live: https://main--xfinity-xwalk--adobedevxsc.aem.live/
...
1. Open the `xfinity-xwalk` directory in your favorite IDE and start coding :)
